...
ALTER TABLE `quiz` ADD CONSTRAINT `FK_quiz_type_TO_quiz_1` FOREIGN KEY (
	`qt_num`
)
...
ALTER TABLE `quiz_attempt` ADD CONSTRAINT `FK_quiz_TO_quiz_attempt_1` FOREIGN KEY (
	`qu_num`
)
REFERENCES `quiz` (
	`qu_num`
